...
This is the Boarding page, This is the first page
of the application
 */
...
public class WalkThroughActivity extends AppCompatActivity {
    ...
    private void addBottomDots(int currentPage) {
        ...
        int[] colorsActive = getResources().getIntArray(R.array.waveloader_colorsarray);
        int[] colorsInactive = getResources().getIntArray(R.array.waveloader_colorsarray);
